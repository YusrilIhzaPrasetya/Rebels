...
function ModalUpdate({closeModal}) {
    return (
        <div className="fixed w-screen h-screen bg-black top-0 left-0 flex justify-center items-center bg-opacity-40">
            <div className="fixed p-6 w-1/3 bg-white drop-shadow-xl rounded-xl">
                ...
                <form action="" className="flex flex-col">
                    ...
                    <div>
                        <button className="border-black border-2 py-2 px-6 mr-5 rounded-lg border-transparent bg-green-500 text-white">Update</button>
                        <button className="border-black border-2 py-2 px-6 rounded-lg border-transparent bg-red-500 text-white">Delete</button>
                    </div>
                </form>
            </div>
        </div>
